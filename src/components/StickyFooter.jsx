...
<div className="md:hidden w-full bg-[#c96c4a] px-4 flex justify-between items-center py-2 space-x-6">       
   <a href="tel:+917045946449" className="flex items-center text-white">
          ...
          <span className="text-md font-sans font-normal">+91 70459 46449</span>
        </a>
        <button
          onClick={openModal}
...
<div className="hidden md:flex w-full bg-white  px-12 items-center justify-center space-x-6 py-3 pb-3">        <h2 className="text-3xl font-serif text-black">Enquire Now</h2>
